...
class QLearningAgent:
    ...
    def learn(self, PreviousState , current_state, action, reward, MaxQValueFromAllPossibleActionsInTheCurrentState):
        print("####Time to Learn! ####")
        ...
        self.Q[(PreviousState, action)] = self.get_Q(PreviousState, action) + \
                                  self.alpha * (reward + self.gamma * 11 - self.get_Q(PreviousState, action))
