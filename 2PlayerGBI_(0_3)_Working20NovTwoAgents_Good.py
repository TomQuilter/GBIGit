        ...
        while self.NumberofGamesPlayedSoFar < agent.TotalNumberOfGamesToPlay:
            ...
            if not moves:
                ...
                if self.current_player == 'X':  # if it's X's turn and there's a Q agent
                        ...
                        reward = -5-5*EuclidianDistanceFromGoal  ## To create quick optimal trajectories for X 
            ...
            # reward = 0  ## By Defaut
            if self.current_player == 'X' and action[1] == self.WinningColumnForX and action[0] == self.WinningRowForX:
                reward = 100               
...
for r in range(1, 2):  # This will generate combinations of lengths 1 to to last number, 3 gives max combo (2, 1, 2, 2)
