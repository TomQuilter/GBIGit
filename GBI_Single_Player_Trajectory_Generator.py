...
class QLearningAgent:
    def __init__(self, alpha=0.1, gamma=0.9
                 , epsilon=0.8, TotalNumberOfGamesToPlay=300):
    ...
    def choose_action(self, state, available_actions, NumberOfGamesPlayedSoFar):
      #r#print("#### CHOOSE ACTION ####")
        RandomNumber = random.uniform(0, 1)
        ExplorationThreshold = self.epsilon*pow(0.985, NumberOfGamesPlayedSoFar)
    ...
    def learn(self, PreviousState , current_state, action, reward, MaxQValueFromAllPossibleActionsInTheNEWState):
      ...
      #r#print("Current state",current_state)
      #r#print("action",action)
      ...
      #r#print("Q-val before", self.get_Q(PreviousState, action))
        ...
        # print("self.Q",self.Q)
      #r#print("Q-val after", self.Q[(PreviousState, action)])
      #r#print("####Learnt! ####")
        #p##r#print("VS CODE!")
...
#            # self.board[i][2] = '#'
    ...
    def ResetThePeicesAtTheEndOfTheGame(self):  
      #r#print("The Game Just Ended! Reset the board guys and girls!")
        ...
        if self.NumberofGamesPlayedSoFar > (agent.TotalNumberOfGamesToPlay - 9): 
          ...
          #r#print("MeanNumberOfMovesPerGameinthlast9games = ", self.MeanNumberOfMovesPerGame)
            
        self.NumberofMovesInTheGameSoFar = -1        
        self.NumberofGamesPlayedSoFar += 1 
        # Player X always starts
        self.current_player = 'X'
      #r#print("##### GAME NUMBER", self.NumberofGamesPlayedSoFar)
        # Initialize the 5x5 game board
        self.board = [[' ' for _ in range(self.NumberOfCols)] for _ in range(self.NumberOfRows)]
        # Set the starting positions of the players
        self.board[0][0] = 'X'
      ...
      #r#print("NumberofXVictoriesInTheGameSoFar",self.NumberofXVictoriesInTheGameSoFar)
      #r#print("NumberofOVictoriesInTheGameSoFar",self.NumberofOVictoriesInTheGameSoFar)
      #r#print("NumberofDrawsInTheGameSoFar",self.NumberofDrawsInTheGameSoFar)

        if self.NumberofGamesPlayedSoFar == agent.TotalNumberOfGamesToPlay:
            ##### Q-Table #####
            for key, value in agent.Q.items():
                agent.Q[key] = round(value, 2)
              #r#print(key, agent.Q[key] )
    ...
    def play(self, q_agent=None, training=True):   
        while self.NumberofGamesPlayedSoFar < agent.TotalNumberOfGamesToPlay:
          #r#print("NumberofGamesPlayedSoFar = ",self.NumberofGamesPlayedSoFar)
            self.NumberofMovesInTheGameSoFar += 1
          #r#print("self.NumberofMovesInTheGameSoFar = ",self.NumberofMovesInTheGameSoFar)
            self.Is_Draw()
            self.print_board()
          #r#print(f"{self.current_player}'s turn")
            ...
            if self.current_player == 'O':  ### OVERIDE FOR DEBUGGING
              ...
              #r#print("0's OVERIDE action = ", action)
